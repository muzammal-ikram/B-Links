            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Sellers Details</div>
                    </div>
                    <div class="card-body">
                        <table id="bs4-table" class="table table-bordered table-striped table-responsive">
                            <tbody>
                            <tr>
                                <th class="text-nowrap" scope="row" style="">Seller Name</th>
                            </tr>
                            @foreach($total_sellers as $key => $seller)
                            <tr>
                                <td><h4>{{$seller[0]['seller_name']}}</h4></td>
                            </tr>
                        @endforeach
                            </tbody>
                        </table>
